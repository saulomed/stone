 ...
 * 
 */
@WebFault(name = "IOException", targetNamespace = "http://webservice.autorizador.stone.com.br/")
    ...
    extends Exception
{
     ...
     * 
     * @return
     *     returns fault bean: br.com.stone.autorizador.transaction.wsclient.IOException
     */
